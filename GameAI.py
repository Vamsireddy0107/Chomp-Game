...
class ChompState:
    def __init__(self, width, height):
        ...
        num_obstacles = int(sqrt(width * height))
    ...
    def DoMove(self, move):
        ...
        if [x, y] == [0, 0]:
            ...
            print("Out of bounds!")
        elif not self.is_cell_open(x, y) and not self.board[x][y] == '*':
    ...
    def GetMoves(self):
        return [(x, y) for x in range(self.height) for y in range(self.width) if self.is_cell_open(x, y)]
